            ...
            schemas: {
                ...
                JobRoleApplicationResponse: {
                    ...
                    properties: {
                        ...
                        cvText: { type: "string", example: "I have 5 years of experience..." },
                    },
                },
                CreateJobRoleRequest: {
                    ...
                    properties: {
                        ...
                        description: { type: "string", example: "Build scalable backend services" },
                        responsibilities: {
                            type: "string",
                            example: "Design APIs, optimize queries, mentor junior developers",
                        },
                        sharepointUrl: {
                            type: "string",
                            format: "uri",
                ...
                CreateJobRoleResponse: {
                    ...
                    properties: {
                        message: { type: "string", example: "Mock create endpoint accepted" },
                        jobRoleDraft: {
                            type: "object",
                            properties: {
