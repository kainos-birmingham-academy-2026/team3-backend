...
describe('JobRole Model', () => {
    it('should create instance with all 9 properties', () => {
        const jobRoleId = 1;
    ...
    it('should have jobRoleId as readonly', () => {
        ...
        // TypeScript prevents this, but we can verify via Object.getOwnPropertyDescriptor
        const descriptor = Object.getOwnPropertyDescriptor(jobRole, 'jobRoleId');
    ...
    it('should accept string type for location', () => {
        const jobRole = new JobRole(1, 'Role', 'London', 1, 1, new Date(), 'OPEN', new Date(), new Date());
